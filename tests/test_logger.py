...
def test_setup_logging_archives_existing_file_and_keeps_canonical_name(monkeypatch, tmp_path):
    monkeypatch.setenv("HOME", str(tmp_path))
...
def test_setup_xmpp_logging_writes_plugin_logs_without_duplicate_handlers(monkeypatch, tmp_path):
...
def test_setup_xmpp_logging_archives_existing_file_and_uses_xmpp_log(monkeypatch, tmp_path):
    log_path = tmp_path / "xmpp.log"
